...
function M.setup(completion_sources)
  vim.api.nvim_create_autocmd('FileType', {
    ...
    callback = function(args)
      ...
      vim.api.nvim_create_autocmd('CompleteDone', { buffer = buf, callback = M._on_complete })
    end,
  })
