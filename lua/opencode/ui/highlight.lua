...
function M.setup()
  ...
  if is_light then
    ...
    vim.api.nvim_set_hl(0, 'OpencodeQueued', { fg = '#D97706', bold = true, default = true })
    ...
    vim.api.nvim_set_hl(0, 'OpencodeContextReviewComment', { link = '@label', default = true })
    vim.api.nvim_set_hl(0, 'OpencodeReviewComment', { link = 'Comment', default = true })
    vim.api.nvim_set_hl(0, 'OpencodeReviewCommentSign', { link = 'DiagnosticInfo', default = true })
    vim.api.nvim_set_hl(0, 'OpencodeReviewCommentStale', { link = 'DiagnosticWarn', default = true })
    ...
    vim.api.nvim_set_hl(0, 'OpencodeReference', { fg = '#5F7896', default = true })
    vim.api.nvim_set_hl(0, 'OpencodeSymbolReference', { link = 'Identifier', default = true })
    ...
    vim.api.nvim_set_hl(0, 'OpencodeMessageRoleUser', { link = 'Question', default = true })
    vim.api.nvim_set_hl(0, 'OpencodeQueued', { fg = '#E5C07B', bold = true, default = true })
    ...
    vim.api.nvim_set_hl(0, 'OpencodePickerTime', { link = 'Comment', default = true })
    vim.api.nvim_set_hl(0, 'OpencodeDebugText', { link = 'Comment', default = true })
    vim.api.nvim_set_hl(0, 'OpencodeReference', { fg = '#8AA6C8', default = true })
    vim.api.nvim_set_hl(0, 'OpencodeSymbolReference', { link = 'Identifier', default = true })
    vim.api.nvim_set_hl(0, 'OpencodeReasoningText', { link = 'Comment', default = true })
    vim.api.nvim_set_hl(0, 'OpencodePermissionTitle', { fg = '#FF9E3B', default = true })
