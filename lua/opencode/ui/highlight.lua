...
function M.setup()
  ...
  vim.api.nvim_set_hl(0, 'OpencodeContextBar', { bg = '#181820', fg = '#393836', default = true })
  ...
  vim.api.nvim_set_hl(0, 'OpencodeInputLegend', { fg = '#CCCCCC', bold = false, default = true })
  vim.api.nvim_set_hl(0, 'OpencodeContext', { fg = '#3b4261', nocombine = true, default = true })
  vim.api.nvim_set_hl(0, 'OpencodeContextAgent', { link = 'Comment', nocombine = true, default = true })
  vim.api.nvim_set_hl(0, 'OpencodeContextCurrentFile', { link = 'Comment', bold = false, default = true })
  vim.api.nvim_set_hl(0, 'OpencodeContextSelection', { bg = '#61AFEF', fg = '#616161', bold = false, default = true })
  vim.api.nvim_set_hl(0, 'OpencodeContextError', { fg = '#e82424' })
  vim.api.nvim_set_hl(0, 'OpencodeContextWarning', { fg = '#ff9a3b' })
  vim.api.nvim_set_hl(0, 'OpencodeContextInfo', { fg = '#659584' })
